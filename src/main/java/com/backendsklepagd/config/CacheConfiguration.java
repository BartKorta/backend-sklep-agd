package com.backendsklepagd.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.backendsklepagd.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.backendsklepagd.repository.UserRepository.USERS_BY_EMAIL_CACHE);
