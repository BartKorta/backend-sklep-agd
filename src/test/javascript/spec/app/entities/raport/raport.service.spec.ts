...
describe('Service Tests', () => {
  describe('Raport Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(RaportService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Raport(0, 'AAAAAAA', currentDate);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            dataUtworzenia: currentDate.format(DATE_TIME_FORMAT),
          },
          elemDefault
        );
      ...
      it('should create a Raport', () => {
        ...
        service.create(new Raport()).subscribe(resp => (expectedResult = resp.body));
