...
describe('Service Tests', () => {
  describe('Zamowienie Service', () => {
    ...
    let expectedResult: IZamowienie | IZamowienie[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      elemDefault = new Zamowienie(0, 0, currentDate);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            dataZamowienia: currentDate.format(DATE_TIME_FORMAT),
          },
          elemDefault
        );
      ...
      it('should create a Zamowienie', () => {
        ...
        const expected = Object.assign(
          {
            dataZamowienia: currentDate,
          },
          returnedFromService
        );

        service.create(new Zamowienie()).subscribe(resp => (expectedResult = resp.body));
